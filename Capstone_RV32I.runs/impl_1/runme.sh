...
HD_PWD='C:/Users/Jedid/Capstone_RV32I/Capstone_RV32I.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_CtrlUnit_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RV32I_CtrlUnit_tb.tcl -notrace

...
HD_PWD='C:/Users/Jedid/Capstone_RV32I/Capstone_RV32I.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_CtrlUnit_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32I_CtrlUnit_tb.tcl
